...
error_reporting(0);
$pasien = array(
    1 => array(1, "2022-01-10", "P001", "Atun", "Wanita", 69.8, 169, 24.7, "Kelebihan Berat Badan"),
        array(2, "2022-01-10", "P002", "Sandy", "Pria", 55.3, 165, 20.3, "Sehat (Ideal)"),
        array(3, "2022-01-10", "P003", "Afifah", "Pria", 45.2, 171, 15,4, "Kekurangan Berat Badan")
);
...
<body>
    <hr>
    <table class="container table-striped table-bordered text-center">
